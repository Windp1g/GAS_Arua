...
FDamageEffectParams UAuraDamageGameplayAbility::MakeDamageEffectParamFromClassDefault(AActor* TargetActor,
	...
	bool bOverrideDeathImpulse, FVector DeathImpulseDirectionOverride, bool bOverridePitch, float PitchOverride) const
{
	...
	if (bIsRadialDamage)
	{
		...
		Params.RadialMinDamage = RadialMinDamage.GetValueAtLevel(GetAbilityLevel());
	}
